<%@ Control Language="C#" CodeBehind="VerticalHomeclickTemplate.ascx.cs" ClassName="VerticalHomeclickTemplate" Inherits="Homeclick.vn.Web.VerticalHomeclickTemplate" %>
