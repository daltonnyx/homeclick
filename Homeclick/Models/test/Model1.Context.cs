...
namespace Homeclick.Models.test
{
    ...
    public partial class vinabits_homeclickEntities2 : DbContext
    {
        public vinabits_homeclickEntities2()
            : base("name=vinabits_homeclickEntities2")
        {
        }
        ...
        public virtual DbSet<PostDanhSachPosts_CategoryDanhSachCategories> PostDanhSachPosts_CategoryDanhSachCategories { get; set; }
        public virtual DbSet<Product> Products { get; set; }
        public virtual DbSet<Product_detail> Product_detail { get; set; }
        public virtual DbSet<Product_type> Product_type { get; set; }
        public virtual DbSet<ProductsLayoutsLink> ProductsLayoutsLinks { get; set; }
        public virtual DbSet<Project> Projects { get; set; }
        public virtual DbSet<ProjectItem> ProjectItems { get; set; }
        public virtual DbSet<ProjectLayout_Collection> ProjectLayout_Collection { get; set; }
