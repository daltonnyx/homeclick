...
namespace Homeclick.Controllers
{
    ...
    public class AccountController : Controller
    {
        public AccountController()
            : this(new CustomUserManager<ApplicationUser>(new UserStore<ApplicationUser>(new ApplicationDbContext())))
        {
        }
        ...
        public CustomUserManager<ApplicationUser> UserManager { get; private set; }
