    ...
    $.fn.formToWizard = function( options, cmdParam1 ) {
        ...
        if( typeof options !== 'string' ) {
            ...
            steps.each(function(i) {
                ...
                if( options.showProgress && typeof(options.progress) !== "function") {
                    if( options.showStepNo ){
                        $("#steps").append("<li id='stepDesc" + i + "' class='step'><span class='step-number'>" + (i + 1) + "</span><span class='step-desc'>" + $(this).data('step-name') + "</span></li>");
                    }
                    else
                        $("#steps").append("<li id='stepDesc" + i + "' class='step'>" + $(this).data('step-name') + "</li>");
                }
